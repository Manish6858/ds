          ...
          <body>
            ...
            <div id='resume'>
                ...
                <div class='sectionContent'>
                  <div class="jobBlock">
                    ...
                    <ul class='highlights'>
                      ...
                      <li>Solved problems by creating a revenue share platform using custom analytics, enhancing editorial workflow and
                        personalizing user feed</li>
                  ...
                  <div class="jobBlock">
                    ...
                    <div><a href=''></a></div>
                    <ul class='highlights'>
                      <li>4.9/5 star rating from 500+ clients with 20% world coverage working remotely. Profile link https://www.fiverr.com/divyenduz</li>
                      <li>Key Skills - React (Best rated), React Native, GraphQL, Node ; Domain - Mixed</li>
                    </ul>
                    <div class='separator'></div>
                  </div>
                  <div class="jobBlock">
                ...
                <div class='sectionContent'>
                  <div class='blockHeader'>
                    ...
                    <ul class='highlights'>
                      ...
                      <li>Writekey: Created a custom blog platform build in Node and GraphQL (https://w3z.in/96b9a)</li>
                      <li>Flask Profiler: Contributed two features (now widely used) to flask profiler library - dump/remove database (https://w3z.in/4b88)
                        and sampling (https://w3z.in/c382)</li>
                    </ul>
                  </div>
                  <div class='separator'></div>
                  <div class='blockHeader'>
                    ...
                    <ul class='highlights'>
                      <li>I review the meta content of video courses including the scripts, slides, sample code, and projects working with
                        a fully remote team</li>
                      <li>Ray Wenderlich is trusted by millions of developers globally for their high-quality content in both article and
                        video format</li>
              ...
              <div id='skills' class="sectionBlock">
                ...
                <div class='sectionContent'>
                  ...
                  <div class='skillBlock'>
                    ...
                    <span>AWS (EC2,S3,RDS,etc.), DO, Jenkins, Docker</span>
                  </div>
                  <div class='skillBlock'>
              ...
              <div id='languages' class="sectionBlock">
                ...
                <div class='sectionContent'>
                  <span class='language'>English (read, write, speak), Spanish (read, write)</span>
