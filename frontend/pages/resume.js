...
@media print {
  ...
  <div id='basicsBlock' class='smallFont'>
    <div class='contactBlock'>
      ...
      <div id='profilesBlock'>
            ...
            <span class='divider'>|</span>
            <span class='url'>
              <a href='https://www.duolingo.com/divyenduz'>Duolingo</a>
            </span>
  ...
  <div id='summaryBlock' class="sectionBlock">
    ...
    <div class='sectionContent'>
      <span>A young computer scientist from a beautiful place called Jammu and Kashmir in India. I love making things that have an impact.</span>
    </div>
  </div>
  <div class='sectionLine'></div>
